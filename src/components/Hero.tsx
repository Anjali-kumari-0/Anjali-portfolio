...
export default function Hero() {
  ...
  return (
    ...
    //           <motion.p className="app-text-description font-medium">Building the future of web</motion.p>
    //         </div>
    //       </div>
    //     </motion.div>
    //   </motion.div>
    ...
    //   </motion.div>
    // </section>
    <section className="px-10 pt-10 pb-20 grid grid-cols-2 items-center">

      {/* LEFT */}
      <div>
        <motion.p className="app-text-primary inline-block px-4 py-1 border border-white/20 rounded-full text-sm mb-6">
          👋 Welcome to my portfolio
        </motion.p>

        <motion.h1 className="app-text-primary text-5xl font-bold leading-tight">
          Hi, I’m Anjali 👋
          <br />
        ...
        <motion.p className="mt-6 text-gray-400 max-w-lg">
          I build scalable, secure & amazing web applications.
          Passionate about clean code, great UI/UX, and building impactful products.
        </motion.p>
      ...
      <div className="relative flex justify-center items-center overflow-visible">
        {/* Background Glow - Taaki edges aur soft lagein */}
        <div className="w-[450px] h-[450px] bg-purple-600/20 blur-[120px] absolute rounded-full"></div>
